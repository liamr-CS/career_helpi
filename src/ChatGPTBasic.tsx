...
function BasicReport({answers} : BasicReportProps) {  
    ...
    return (
        <div>
            ...
            {isLoading ? (<div><h2>Loading...</h2></div>) : report === "Error: Report failed to generate" ? (<div><h2>{report}</h2></div>) : report === "" ? (<div><h2>Press the button above to get your results for the Basic Quiz!</h2></div>) : 
                (
                    <div>
